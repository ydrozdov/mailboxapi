...
namespace Proxies\__CG__\Mailbox\Documents;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Item extends \Mailbox\Documents\Item implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '_id', 'uid', 'sender', 'subject', 'message', 'time_sent'];
        }
